...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "skus", postgresql.ARRAY(postgresql.UUID(as_uuid=True)), nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_warehouse_invoice_id"), "warehouse_invoice", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_warehouse_invoice_parent_invoice_id"),
        "warehouse_invoice",
        ["parent_invoice_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_warehouse_invoice_warehouse_id"),
        "warehouse_invoice",
        ["warehouse_id"],
        unique=False,
    )
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        op.f("ix_warehouse_invoice_warehouse_id"), table_name="warehouse_invoice"
    )
    op.drop_index(
        op.f("ix_warehouse_invoice_parent_invoice_id"), table_name="warehouse_invoice"
    )
    op.drop_index(op.f("ix_warehouse_invoice_id"), table_name="warehouse_invoice")
    op.drop_index(
        "idx_orderedby_created_date_warehouse_invoice",
        table_name="warehouse_invoice",
        postgresql_using="btree",
    )
