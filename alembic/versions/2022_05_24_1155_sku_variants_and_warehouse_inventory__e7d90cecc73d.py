...
def upgrade():
    ...
    op.create_index(
        "idx_row_column", "warehouse_inventory", ["row", "column"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_sku_variant_parent_sku"), "sku_variant", ["parent_sku"], unique=False
    )
...
def downgrade():
    ...
    op.drop_index(
        op.f("ix_warehouse_inventory_warehouse_id"), table_name="warehouse_inventory"
    )
