...
def upgrade():
    ...
    op.add_column(
        "sku_variant", sa.Column("parent_sku_id", postgresql.UUID(), nullable=False)
    )
    op.drop_index("ix_sku_variant_parent_sku", table_name="sku_variant")
    op.create_index(
        op.f("ix_sku_variant_parent_sku_id"),
        "sku_variant",
        ["parent_sku_id"],
        unique=False,
    )
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        "idx_sku_variants", table_name="warehouse_inventory", postgresql_using="gin"
    )
    op.add_column(
        "sku_variant",
        sa.Column("parent_sku", postgresql.UUID(), autoincrement=False, nullable=False),
    )
    op.drop_constraint(None, "sku_variant", type_="foreignkey")
    op.create_foreign_key(
        "sku_variant_parent_sku_fkey", "sku_variant", "sku", ["parent_sku"], ["id"]
    )
    op.drop_index(op.f("ix_sku_variant_parent_sku_id"), table_name="sku_variant")
    op.create_index(
        "ix_sku_variant_parent_sku", "sku_variant", ["parent_sku"], unique=False
    )
